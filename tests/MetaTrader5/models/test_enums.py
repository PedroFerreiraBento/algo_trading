...
# Test for ENUM_WEEKDAY
def test_enum_weekday():
    """
    Test for ENUM_WEEKDAY enum to ensure correct mappings for days of the week.
    """
    assert ENUM_WEEKDAY.SUNDAY == 0, "SUNDAY should be 0"
    assert ENUM_WEEKDAY.MONDAY == 1, "MONDAY should be 1"
    assert ENUM_WEEKDAY.TUESDAY == 2, "TUESDAY should be 2"
    assert ENUM_WEEKDAY.WEDNESDAY == 3, "WEDNESDAY should be 3"
    assert ENUM_WEEKDAY.THURSDAY == 4, "THURSDAY should be 4"
    assert ENUM_WEEKDAY.FRIDAY == 5, "FRIDAY should be 5"
    assert ENUM_WEEKDAY.SATURDAY == 6, "SATURDAY should be 6"

    # Additional check to ensure the correct names
    assert ENUM_WEEKDAY(3).name == "WEDNESDAY", "Day 3 should be WEDNESDAY"
    assert ENUM_WEEKDAY(0).name == "SUNDAY", "Day 0 should be SUNDAY"

# Test for ENUM_COPY_TICKS
def test_enum_copy_ticks():
    assert ENUM_COPY_TICKS.COPY_TICKS_ALL == mt5.COPY_TICKS_ALL
    assert ENUM_COPY_TICKS.COPY_TICKS_INFO == mt5.COPY_TICKS_INFO
    assert ENUM_COPY_TICKS.COPY_TICKS_TRADE == mt5.COPY_TICKS_TRADE

# Test for ENUM_SYMBOL_SWAP_MODE
def test_enum_symbol_swap_mode():
    assert ENUM_SYMBOL_SWAP_MODE.SYMBOL_SWAP_MODE_DISABLED == mt5.SYMBOL_SWAP_MODE_DISABLED
    assert ENUM_SYMBOL_SWAP_MODE.SYMBOL_SWAP_MODE_POINTS == mt5.SYMBOL_SWAP_MODE_POINTS
    assert ENUM_SYMBOL_SWAP_MODE.SYMBOL_SWAP_MODE_CURRENCY_SYMBOL == mt5.SYMBOL_SWAP_MODE_CURRENCY_SYMBOL
    assert ENUM_SYMBOL_SWAP_MODE.SYMBOL_SWAP_MODE_CURRENCY_MARGIN == mt5.SYMBOL_SWAP_MODE_CURRENCY_MARGIN
    assert ENUM_SYMBOL_SWAP_MODE.SYMBOL_SWAP_MODE_CURRENCY_DEPOSIT == mt5.SYMBOL_SWAP_MODE_CURRENCY_DEPOSIT
    assert ENUM_SYMBOL_SWAP_MODE.SYMBOL_SWAP_MODE_INTEREST_CURRENT == mt5.SYMBOL_SWAP_MODE_INTEREST_CURRENT
    assert ENUM_SYMBOL_SWAP_MODE.SYMBOL_SWAP_MODE_INTEREST_OPEN == mt5.SYMBOL_SWAP_MODE_INTEREST_OPEN
    assert ENUM_SYMBOL_SWAP_MODE.SYMBOL_SWAP_MODE_REOPEN_CURRENT == mt5.SYMBOL_SWAP_MODE_REOPEN_CURRENT
    assert ENUM_SYMBOL_SWAP_MODE.SYMBOL_SWAP_MODE_REOPEN_BID == mt5.SYMBOL_SWAP_MODE_REOPEN_BID


# Test for ENUM_SYMBOL_CALC_MODE
def test_enum_symbol_calc_mode():
    assert ENUM_SYMBOL_CALC_MODE.SYMBOL_CALC_MODE_FOREX == mt5.SYMBOL_CALC_MODE_FOREX
    assert ENUM_SYMBOL_CALC_MODE.SYMBOL_CALC_MODE_FOREX_NO_LEVERAGE == mt5.SYMBOL_CALC_MODE_FOREX_NO_LEVERAGE
    assert ENUM_SYMBOL_CALC_MODE.SYMBOL_CALC_MODE_FUTURES == mt5.SYMBOL_CALC_MODE_FUTURES
    assert ENUM_SYMBOL_CALC_MODE.SYMBOL_CALC_MODE_CFD == mt5.SYMBOL_CALC_MODE_CFD
    assert ENUM_SYMBOL_CALC_MODE.SYMBOL_CALC_MODE_CFDINDEX == mt5.SYMBOL_CALC_MODE_CFDINDEX
    assert ENUM_SYMBOL_CALC_MODE.SYMBOL_CALC_MODE_CFDLEVERAGE == mt5.SYMBOL_CALC_MODE_CFDLEVERAGE
    assert ENUM_SYMBOL_CALC_MODE.SYMBOL_CALC_MODE_EXCH_STOCKS == mt5.SYMBOL_CALC_MODE_EXCH_STOCKS
    assert ENUM_SYMBOL_CALC_MODE.SYMBOL_CALC_MODE_EXCH_FUTURES == mt5.SYMBOL_CALC_MODE_EXCH_FUTURES
    assert ENUM_SYMBOL_CALC_MODE.SYMBOL_CALC_MODE_EXCH_BONDS == mt5.SYMBOL_CALC_MODE_EXCH_BONDS
    assert ENUM_SYMBOL_CALC_MODE.SYMBOL_CALC_MODE_EXCH_STOCKS_MOEX == mt5.SYMBOL_CALC_MODE_EXCH_STOCKS_MOEX
    assert ENUM_SYMBOL_CALC_MODE.SYMBOL_CALC_MODE_EXCH_BONDS_MOEX == mt5.SYMBOL_CALC_MODE_EXCH_BONDS_MOEX
    assert ENUM_SYMBOL_CALC_MODE.SYMBOL_CALC_MODE_SERV_COLLATERAL == mt5.SYMBOL_CALC_MODE_SERV_COLLATERAL
...
# Test for ENUM_TICK_FLAGS
def test_enum_tick_flags():
    assert ENUM_TICK_FLAGS.TICK_FLAG_BID == mt5.TICK_FLAG_BID
    assert ENUM_TICK_FLAGS.TICK_FLAG_ASK == mt5.TICK_FLAG_ASK
    assert ENUM_TICK_FLAGS.TICK_FLAG_LAST == mt5.TICK_FLAG_LAST
    assert ENUM_TICK_FLAGS.TICK_FLAG_VOLUME == mt5.TICK_FLAG_VOLUME
    assert ENUM_TICK_FLAGS.TICK_FLAG_BUY == mt5.TICK_FLAG_BUY
    assert ENUM_TICK_FLAGS.TICK_FLAG_SELL == mt5.TICK_FLAG_SELL
...
def test_enum_timeframe():
    ...
    assert ENUM_TIMEFRAME.TIMEFRAME_M12 == mt5.TIMEFRAME_M12
    ...
    assert ENUM_TIMEFRAME.TIMEFRAME_W1 == mt5.TIMEFRAME_W1
